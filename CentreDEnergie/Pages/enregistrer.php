...
<div class="row" id="title_register">
...
<div class="row">
	<form method="POST">
		<div id="div_Username">
			...
			<span id="usernameTip" class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="right" title="Le nom d'utilisateur peut avoir jusqu'à 15 charactères et doit être unique."></span>			
		</div>
		<br>
		<div id="div_Password">
